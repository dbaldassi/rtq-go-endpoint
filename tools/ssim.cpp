...
int main(int argc, char *argv[])
{
	...
	ofs << frameNum << ",";
        ...
        ofs << setiosflags(ios::fixed) << setprecision(3) << psnrV << ",";
	
	mssimV = getMSSIM(frameReference, frameUnderTest);
	    
	ofs << setiosflags(ios::fixed) << setprecision(2) << mssimV.val[2] * 100 << ","
	    << setiosflags(ios::fixed) << setprecision(2) << mssimV.val[1] * 100 << ","
	    << setiosflags(ios::fixed) << setprecision(2) << mssimV.val[0] * 100 << endl; 
    }
